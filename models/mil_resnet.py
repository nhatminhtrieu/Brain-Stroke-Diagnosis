...
class CNN_Attention(BaseModel):
    ...
    def forward(self, bags):
        ...
        att_out, att_weights = self.att_layer(cnn_features)
...
class CNN_ATT_GP_Multilabel(BaseModel):
    def __init__(self, params=None):
        ...
        self.fc_for_combine = nn.Linear(9 * self.NUM_CLASSES, self.NUM_CLASSES)
    ...
    def forward(self, bag):
        ...
        if self.NUM_CLASSES == 1:
            att_outputs, att_weights = self.attention_layers(x)
